...
Public Class SharePointListTransactions
    ...
    Friend SharePointFileAttach, ValuesList, FieldsList As New ArrayList
    ...
    Friend Sub InsertItem()
        ...
        If SharePointFileAttach.Count > 0 Then

            For i = 0 To SharePointFileAttach.Count - 1
                SaveAttachment(oListItem, SharePointFileAttach(i)(2))
            Next
    ...
    Function SaveAttachment(ByVal item As ListItem, ByVal path As String) As Attachment
        Dim ctx = item.Context
        Dim attachmentInfo = New AttachmentCreationInformation()
        ...
        Using fs = New FileStream(path, FileMode.Open)
            ...
            Dim attachment = item.AttachmentFiles.Add(attachmentInfo)
            ctx.ExecuteQuery()
            Return attachment
        End Using
    End Function
