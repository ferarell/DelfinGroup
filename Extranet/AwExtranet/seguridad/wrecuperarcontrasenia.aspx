<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wrecuperarcontrasenia.aspx.vb" Inherits="AwExtranet.wrecuperarcontrasenia" %>
            ...
            <form id="form1" runat="server">
                <div class="form-group has-feedback">
                    ...
                    <span class="form-control-feedback">
                        <img src="/static/img/mail.png"></span>
                </div>
                <div class="row">
                    <div class="col-xs-6">
                    ...
                    <div class="col-xs-6">
                        <dx:BootstrapButton ID="btnRecuperar" runat="server" AutoPostBack="false" Text="Enviar">
