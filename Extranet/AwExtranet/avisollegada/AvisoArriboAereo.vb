...
Public Class AvisoArriboAereo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AwExtranet.AvisoArriboAereo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedAvisoArriboAereo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As AvisoArriboAereo = New AvisoArriboAereo()
        rpt.Site = Me.Site
        Return rpt
    End Function
