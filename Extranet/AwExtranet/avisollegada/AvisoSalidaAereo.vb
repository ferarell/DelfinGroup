...
Public Class AvisoSalidaAereo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AwExtranet.AvisoSalidaAereo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedAvisoSalidaAereo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As AvisoSalidaAereo = New AvisoSalidaAereo()
        rpt.Site = Me.Site
        Return rpt
    End Function
