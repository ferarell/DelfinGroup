...
namespace Delfin.Principal
{
   public class MAN004Presenter
   {
      ...
      public void Nuevo()
      {
         try
         {
            ...
            this.Item.ServiciosDocumentosDelete = new ObservableCollection<ServiciosDocumentos>();
                ...
                this.Item.ServiciosLineaNegocio = new ObservableCollection<ServiciosLineaNegocio>();
      ...
      public ObservableCollection<Constantes> ListTiposRGM { get; set; }
      public ObservableCollection<Constantes> ListTiposVIA { get; set; }
      public ObservableCollection<TiposEntidad> ListTiposEntidad { get; set; }
      public ObservableCollection<Servicio> ListServiciosAgrupador { get; set; }
      public ObservableCollection<Servicio> ListServiciosUnificador { get; set; }
        public ObservableCollection<Constantes> ListTiposServicios { get; set; }


        public ObservableCollection<TiposEntidad> ListTiposEntidadDocumentos { get; set; }
        #endregion
