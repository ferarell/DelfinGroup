   ...
   public partial class MAN009LView : UserControl, IMAN009LView
   {
      ...
      public event Infrastructure.Client.FormClose.FormCloseEventArgs.FormCloseEventHandler CloseForm;
        ...
        private void btnMAN_SyncSAP_Click(object sender, EventArgs e)
        {
            ...
            {
                Infrastructure.WinForms.Controls.Dialogos.MostrarMensajeError(Presenter.Title, "Ocurrió un error al actualizar los datos en SAP.");
            }
        ...
        private void grdItems_SelectionChanged(object sender, EventArgs e)
        {
            ...
            if (grdItems.CurrentRow.Cells["ENTC_Activo"].Value is true)
            {
