      ...
      public void LoadView()
      {
         try
         {
            ...
            cmbTIPO_CodTRF.LoadControl(Presenter.ContainerService, "Tipos de Trafico", "TRF", "< Seleccionar Trafico >", ListSortDirection.Ascending);
                //22062020 Segmentos
                cmbTIPO_CodSEG.LoadControl(Presenter.ContainerService, "Tipos de Segmentos", "SEG", "< Seleccionar Segmento >", ListSortDirection.Ascending);
      ...
      public void ClearItem()
      {
         try
         {
            ...
            cmbCONS_CodTFT.SelectedIndex = 0;
                ...
                //Segmento 22062020
                cmbTIPO_CodSEG.SelectedIndex = 0;
         ...
         try
         {
            ...
            else
            {
               ...
               Presenter.Item.TIPO_CodHol = null;
                ...
                //Tipo Segmento 22062020

                if (cmbTIPO_CodSEG.TiposSelectedItem != null)
                {
                    //Presenter.Item.TIPO_TabSeg = cmbTIPO_CodSEG.TiposSelectedItem.TIPO_CodTabla;
                    Presenter.Item.TIPO_CodSEG = cmbTIPO_CodSEG.TiposSelectedItem.TIPO_CodTipo;
                }
                else
                {
                    //Presenter.Item.TIPO_TabSeg = null;
                    Presenter.Item.TIPO_CodSEG = null;
                }
      ...
      public void SetItem()
      {
         try
         {
            ...
            cmbTIPO_CodHOL.SelectedIndex = 0; if (Presenter.Item.TIPO_CodHol != null) { cmbTIPO_CodHOL.SelectedValue = Presenter.Item.TIPO_CodHol; }
                ...
                //Segmento 22062020
                cmbTIPO_CodSEG.SelectedIndex = 0; if (Presenter.Item.TIPO_CodSEG != null) { cmbTIPO_CodSEG.SelectedValue = Presenter.Item.TIPO_CodSEG; }
      ...
      private void VisualizarDatosCliente(Boolean IsVisible)
      {
         try
         {
            ...
            cmbTIPO_CodHOL.Visible = IsVisible;
                ...
                //Segment 22062020
                cmbTIPO_CodSEG.Visible = IsVisible;
