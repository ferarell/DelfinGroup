...
namespace Delfin.Principal
{
   public partial class PRO003MView : Form, IPRO003MView
   {
      ...
      public ObservableCollection<Constantes> ListTiposLNG { get; set; }
      #endregion
      ...
      private void FormatDataGridServicos()
      {
         try
         {
            ...
            grdItemsServicios.Columns["CONS_Desc_TMC"].ReadOnly = true;

            grdItemsServicios.Columns.Add("CONS_Desc_Servicio", "Servicio", "CONS_Desc_Servicio");
            grdItemsServicios.Columns["CONS_Desc_Servicio"].Width = 180;
            grdItemsServicios.Columns["CONS_Desc_Servicio"].ReadOnly = true;
            ...
            _LineaNegocio.HeaderText = "Linea de Negocio";
            ...
            this.grdItemsServicios.Columns.Add(_LineaNegocio);            
            this.grdItemsServicios.Columns["CONS_CodLNG"].Width = 170;
            this.grdItemsServicios.Columns["CONS_CodLNG"].ReadOnly = false;

            grdItemsServicios.Columns.Add("Proveedor", "Proveedor", "Proveedor");
            grdItemsServicios.Columns["Proveedor"].Width = 200;
                grdItemsServicios.Columns["Proveedor"].ReadOnly = true;

                grdItemsServicios.Columns.Add("SOPE_Cantidad", "Cantidad", "SOPE_Cantidad");
            grdItemsServicios.Columns["SOPE_Cantidad"].Width = 70;
                grdItemsServicios.Columns["SOPE_Cantidad"].ReadOnly = true;
            ...
            grdItemsServicios.Columns["SOPE_ImporteIngreso"].Width = 70;
                grdItemsServicios.Columns["SOPE_ImporteIngreso"].ReadOnly = true;
            ...
            grdItemsServicios.Columns["SOPE_ImporteEgreso"].Width = 70;
                grdItemsServicios.Columns["SOPE_ImporteEgreso"].ReadOnly = true;
