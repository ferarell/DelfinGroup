      ...
      public bool Guardar(Boolean EsProspecto, Boolean ShowMessage)
      {
         try
         {
            ...
            if (Item.Validar(ref FleteNegativo))
            {
               ...
               if (Item.CCOT_Tipo == Delfin.Controls.variables.CCOT_TipoOrdenVenta && (Item.CONS_CodEST == Delfin.Controls.variables.CONS_ESTOVEANULADA)) //Item.CONS_CodEST == Delfin.Controls.variables.CONS_ESTOVECONFIRMADA || 
               {
