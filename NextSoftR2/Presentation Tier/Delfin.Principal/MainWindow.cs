...
namespace Delfin.Principal
{
   public partial class MainWindow : Form
   {
      ...
      private void OPE011Desglose_Click(object sender, EventArgs e)
      {
        ...
        ApplicationForm.MailCargoNoticeForm OPE013_mview;

        private void OPE013GesionAvisos_Click(object sender, EventArgs e)
        {
            try
            {
                if (OPE013_mview == null)
                {
                    OPE013_mview = new ApplicationForm.MailCargoNoticeForm();
                    OPE013_mview.AppUser = ItemUsuario.USUA_CodUsr;
                    OPE013_mview.TopLevel = false;
                    OPE013_mview.Dock = DockStyle.Fill;
                    OPE013_mview.FormBorderStyle = FormBorderStyle.None;
                    _pageView = new RadPageViewPage();
                    OPE013_mview.Parent = _pageView;
                    _pageView.Controls.Add(OPE013_mview);
                    _pageView.Text = OPE013_mview.Text;
                    _pageView.Tag = ((System.Windows.Forms.ToolStripItem)(sender)).Tag;
                    tabViews.Pages.Add(_pageView);
                    OPE013_mview.Show();
                }
        ...
        ApplicationForm.LoadingListForm OPE014_mview;

        private void OPE014ImportarLoadingList_Click(object sender, EventArgs e)
        {
            try
            {
                if (OPE014_mview == null)
                {
                    OPE014_mview = new ApplicationForm.LoadingListForm();
                    OPE014_mview.AppUser = ItemUsuario.USUA_CodUsr;
                    OPE014_mview.TopLevel = false;
                    OPE014_mview.Dock = DockStyle.Fill;
                    OPE014_mview.FormBorderStyle = FormBorderStyle.None;
                    _pageView = new RadPageViewPage();
                    OPE014_mview.Parent = _pageView;
                    _pageView.Controls.Add(OPE014_mview);
                    _pageView.Text = OPE014_mview.Text;
                    _pageView.Tag = ((System.Windows.Forms.ToolStripItem)(sender)).Tag;
                    tabViews.Pages.Add(_pageView);
                    OPE014_mview.Show();
                }
            ...
            {
                Dialogos.MostrarMensajeError(Text, "Ha Ocurrido un error al llamar la vista: Importar Loading List", ex);
            }
            tabViews.SelectedPage = _pageView;
        }

        ApplicationForm.EventManagementForm OPE015_mview;

        private void OPE015GestionEventos_Click(object sender, EventArgs e)
        {
            try
            {
                if (OPE015_mview == null)
                {
                    OPE015_mview = new ApplicationForm.EventManagementForm();
                    OPE015_mview.AppUser = ItemUsuario.USUA_CodUsr;
                    OPE015_mview.TopLevel = false;
                    OPE015_mview.Dock = DockStyle.Fill;
                    OPE015_mview.FormBorderStyle = FormBorderStyle.None;
                    _pageView = new RadPageViewPage();
                    OPE015_mview.Parent = _pageView;
                    _pageView.Controls.Add(OPE015_mview);
                    _pageView.Text = OPE015_mview.Text;
                    _pageView.Tag = ((System.Windows.Forms.ToolStripItem)(sender)).Tag;
                    tabViews.Pages.Add(_pageView);
                    OPE015_mview.Show();
                }
            ...
            {
                Dialogos.MostrarMensajeError(Text, "Ha Ocurrido un error al llamar la vista: Gestión de Eventos", ex);
            }
            tabViews.SelectedPage = _pageView;
        }
        ...
        private void COM014EmpresaVinculada_Click(object sender, EventArgs e)
        {
            ...
            {
                Dialogos.MostrarMensajeError(Text, "Ha Ocurrido un error al llamar la vista: Vinculación de Empresa", ex);
            }
            tabViews.SelectedPage = _pageView;
        }

        ApplicationForm.ConsolidatedInquiryForm COM015_mview;

        private void COM015ConsultaIntegral_Click(object sender, EventArgs e)
        {
            try
            {
                if (COM015_mview == null)
                {
                    COM015_mview = new ApplicationForm.ConsolidatedInquiryForm();
                    //COM015_mview.AppUser = ItemUsuario.USUA_CodUsr;
                    COM015_mview.TopLevel = false;
                    COM015_mview.Dock = DockStyle.Fill;
                    COM015_mview.FormBorderStyle = FormBorderStyle.None;
                    _pageView = new RadPageViewPage();
                    COM015_mview.Parent = _pageView;
                    _pageView.Controls.Add(COM015_mview);
                    _pageView.Text = COM015_mview.Text;
                    _pageView.Tag = ((System.Windows.Forms.ToolStripItem)(sender)).Tag;
                    tabViews.Pages.Add(_pageView);
                    COM015_mview.Show();
                }
            ...
            {
                Dialogos.MostrarMensajeError(Text, "Ha Ocurrido un error al llamar la vista: Consulta Integral", ex);
            }
            tabViews.SelectedPage = _pageView;
        }
      ...
      private void REP010DocumentosContabilizados_Click(object sender, EventArgs e)
      {
        ...
        ApplicationForm.GroupForm TAR001_mview;

        private void TAR001Grupos_Click(object sender, EventArgs e)
        {
            try
            {
                if (TAR001_mview == null)
                {
                    TAR001_mview = new ApplicationForm.GroupForm();
                    TAR001_mview.AppUser = ItemUsuario.USUA_CodUsr;
                    TAR001_mview.TopLevel = false;
                    TAR001_mview.Dock = DockStyle.Fill;
                    TAR001_mview.FormBorderStyle = FormBorderStyle.None;
                    //TAR001_mview.WindowState = FormWindowState.Maximized;
                    _pageView = new RadPageViewPage();
                    TAR001_mview.Parent = _pageView;
                    _pageView.Controls.Add(TAR001_mview);
                    _pageView.Text = TAR001_mview.Text;
                    _pageView.Tag = ((System.Windows.Forms.ToolStripItem)(sender)).Tag;
                    tabViews.Pages.Add(_pageView);
                    TAR001_mview.Show();
                }
            ...
            {
                Dialogos.MostrarMensajeError(Text, "Ha Ocurrido un error al llamar la vista: Grupos Empresariales", ex);
            }
            tabViews.SelectedPage = _pageView;
        }

        ApplicationForm.CompanyForm TAR002_mview;

        private void TAR002Empresas_Click(object sender, EventArgs e)
        {
            try
            {
                if (TAR002_mview == null)
                {
                    TAR002_mview = new ApplicationForm.CompanyForm();
                    TAR002_mview.AppUser = ItemUsuario.USUA_CodUsr;
                    TAR002_mview.TopLevel = false;
                    TAR002_mview.Dock = DockStyle.Fill;
                    TAR002_mview.FormBorderStyle = FormBorderStyle.None;
                    //TAR002_mview.WindowState = FormWindowState.Maximized;
                    _pageView = new RadPageViewPage();
                    TAR002_mview.Parent = _pageView;
                    _pageView.Controls.Add(TAR002_mview);
                    _pageView.Text = TAR002_mview.Text;
                    _pageView.Tag = ((System.Windows.Forms.ToolStripItem)(sender)).Tag;
                    tabViews.Pages.Add(_pageView);
                    TAR002_mview.Show();
                }
            ...
            {
                Dialogos.MostrarMensajeError(Text, "Ha Ocurrido un error al llamar la vista: Empresas", ex);
            }
            tabViews.SelectedPage = _pageView;
        }

        ApplicationForm.BusinessUnitForm TAR003_mview;

        private void TAR003UnidadesNegocio_Click(object sender, EventArgs e)
        {
            try
            {
                if (TAR003_mview == null)
                {
                    TAR003_mview = new ApplicationForm.BusinessUnitForm();
                    TAR003_mview.AppUser = ItemUsuario.USUA_CodUsr;
                    TAR003_mview.TopLevel = false;
                    TAR003_mview.Dock = DockStyle.Fill;
                    TAR003_mview.FormBorderStyle = FormBorderStyle.None;
                    //TAR003_mview.WindowState = FormWindowState.Maximized;
                    _pageView = new RadPageViewPage();
                    TAR003_mview.Parent = _pageView;
                    _pageView.Controls.Add(TAR003_mview);
                    _pageView.Text = TAR003_mview.Text;
                    _pageView.Tag = ((System.Windows.Forms.ToolStripItem)(sender)).Tag;
                    tabViews.Pages.Add(_pageView);
                    TAR003_mview.Show();
                }
        ...
        ApplicationForm.AttributeForm TAR004_mview;

        private void TAR004Atributos_Click(object sender, EventArgs e)
        {
            try
            {
                if (TAR004_mview == null)
                {
                    TAR004_mview = new ApplicationForm.AttributeForm();
                    TAR004_mview.AppUser = ItemUsuario.USUA_CodUsr;
                    TAR004_mview.TopLevel = false;
                    TAR004_mview.Dock = DockStyle.Fill;
                    TAR004_mview.FormBorderStyle = FormBorderStyle.None;
                    //TAR004_mview.WindowState = FormWindowState.Maximized;
                    _pageView = new RadPageViewPage();
                    TAR004_mview.Parent = _pageView;
                    _pageView.Controls.Add(TAR004_mview);
                    _pageView.Text = TAR004_mview.Text;
                    _pageView.Tag = ((System.Windows.Forms.ToolStripItem)(sender)).Tag;
                    tabViews.Pages.Add(_pageView);
                    TAR004_mview.Show();
                }
            ...
            {
                Dialogos.MostrarMensajeError(Text, "Ha Ocurrido un error al llamar la vista: Atributos", ex);
            }
            tabViews.SelectedPage = _pageView;
        }

        ApplicationForm.ConceptForm TAR005_mview;

        private void TAR005Conceptos_Click(object sender, EventArgs e)
        {
            try
            {
                if (TAR005_mview == null)
                {
                    TAR005_mview = new ApplicationForm.ConceptForm();
                    TAR005_mview.AppUser = ItemUsuario.USUA_CodUsr;
                    TAR005_mview.TopLevel = false;
                    TAR005_mview.Dock = DockStyle.Fill;
                    TAR005_mview.FormBorderStyle = FormBorderStyle.None;
                    //TAR005_mview.WindowState = FormWindowState.Maximized;
                    _pageView = new RadPageViewPage();
                    TAR005_mview.Parent = _pageView;
                    _pageView.Controls.Add(TAR005_mview);
                    _pageView.Text = TAR005_mview.Text;
                    _pageView.Tag = ((System.Windows.Forms.ToolStripItem)(sender)).Tag;
                    tabViews.Pages.Add(_pageView);
                    TAR005_mview.Show();
                }
            ...
            {
                Dialogos.MostrarMensajeError(Text, "Ha Ocurrido un error al llamar la vista: Conceptos", ex);
            }
            tabViews.SelectedPage = _pageView;
        }
        ...
        private void TAR007Condiciones_Click(object sender, EventArgs e)
        {
            try
            {
                if (TAR007_mview == null)
                {
                    TAR007_mview = new ApplicationForm.ConditionForm();
                    TAR007_mview.AppUser = ItemUsuario.USUA_CodUsr;
                    TAR007_mview.TopLevel = false;
                    TAR007_mview.Dock = DockStyle.Fill;
                    TAR007_mview.FormBorderStyle = FormBorderStyle.None;
                    //TAR007_mview.WindowState = FormWindowState.Maximized;
                    _pageView = new RadPageViewPage();
                    TAR007_mview.Parent = _pageView;
                    _pageView.Controls.Add(TAR007_mview);
                    _pageView.Text = TAR007_mview.Text;
                    _pageView.Tag = ((System.Windows.Forms.ToolStripItem)(sender)).Tag;
                    tabViews.Pages.Add(_pageView);
                    TAR007_mview.Show();
                }
            ...
            {
                Dialogos.MostrarMensajeError(Text, "Ha Ocurrido un error al llamar la vista: Condiciones", ex);
            }
            tabViews.SelectedPage = _pageView;
        }

        ApplicationForm.UnitForm TAR008_mview;

        private void TAR008Unidades_Click(object sender, EventArgs e)
        {
            try
            {
                if (TAR008_mview == null)
                {
                    TAR008_mview = new ApplicationForm.UnitForm();
                    TAR008_mview.AppUser = ItemUsuario.USUA_CodUsr;
                    TAR008_mview.TopLevel = false;
                    TAR008_mview.Dock = DockStyle.Fill;
                    TAR008_mview.FormBorderStyle = FormBorderStyle.None;
                    //TAR008_mview.WindowState = FormWindowState.Maximized;
                    _pageView = new RadPageViewPage();
                    TAR008_mview.Parent = _pageView;
                    _pageView.Controls.Add(TAR008_mview);
                    _pageView.Text = TAR008_mview.Text;
                    _pageView.Tag = ((System.Windows.Forms.ToolStripItem)(sender)).Tag;
                    tabViews.Pages.Add(_pageView);
                    TAR008_mview.Show();
                }
            ...
            {
                Dialogos.MostrarMensajeError(Text, "Ha Ocurrido un error al llamar la vista: Unidades de Medida", ex);
            }
            tabViews.SelectedPage = _pageView;
        }

        ApplicationForm.LayoutForm TAR009_mview;

        private void TAR009Plantillas_Click(object sender, EventArgs e)
        {
            try
            {
                if (TAR009_mview == null)
                {
                    TAR009_mview = new ApplicationForm.LayoutForm();
                    TAR009_mview.AppUser = ItemUsuario.USUA_CodUsr;
                    TAR009_mview.TopLevel = false;
                    TAR009_mview.Dock = DockStyle.Fill;
                    TAR009_mview.FormBorderStyle = FormBorderStyle.None;
                    //TAR009_mview.WindowState = FormWindowState.Maximized;
                    _pageView = new RadPageViewPage();
                    TAR009_mview.Parent = _pageView;
                    _pageView.Controls.Add(TAR009_mview);
                    _pageView.Text = TAR009_mview.Text;
                    _pageView.Tag = ((System.Windows.Forms.ToolStripItem)(sender)).Tag;
                    tabViews.Pages.Add(_pageView);
                    TAR009_mview.Show();
                }
            ...
            {
                Dialogos.MostrarMensajeError(Text, "Ha Ocurrido un error al llamar la vista: Plantillas", ex);
            }
            tabViews.SelectedPage = _pageView;
        }

        ApplicationForm.TariffForm TAR010_mview;

        private void TAR010Tarifas_Click(object sender, EventArgs e)
        {
            try
            {
                if (TAR010_mview == null)
                {
                    TAR010_mview = new ApplicationForm.TariffForm();
                    TAR010_mview.AppUser = ItemUsuario.USUA_CodUsr;
                    TAR010_mview.TopLevel = false;
                    TAR010_mview.Dock = DockStyle.Fill;
                    TAR010_mview.FormBorderStyle = FormBorderStyle.None;
                    //TAR010_mview.WindowState = FormWindowState.Maximized;
                    _pageView = new RadPageViewPage();
                    TAR010_mview.Parent = _pageView;
                    _pageView.Controls.Add(TAR010_mview);
                    _pageView.Text = TAR010_mview.Text;
                    _pageView.Tag = ((System.Windows.Forms.ToolStripItem)(sender)).Tag;
                    tabViews.Pages.Add(_pageView);
                    TAR010_mview.Show();
                }
            ...
            {
                Dialogos.MostrarMensajeError(Text, "Ha Ocurrido un error al llamar la vista: Tarifas", ex);
            }
            tabViews.SelectedPage = _pageView;
        }

        ApplicationForm.TariffInquiryForm TAR011_mview;

        private void TAR011ConsultaTarifas_Click(object sender, EventArgs e)
        {
            try
            {
                if (TAR011_mview == null)
                {
                    TAR011_mview = new ApplicationForm.TariffInquiryForm();
                    //TAR011_mview.AppUser = ItemUsuario.USUA_CodUsr;
                    TAR011_mview.TopLevel = false;
                    TAR011_mview.Dock = DockStyle.Fill;
                    TAR011_mview.FormBorderStyle = FormBorderStyle.None;
                    //TAR010_mview.WindowState = FormWindowState.Maximized;
                    _pageView = new RadPageViewPage();
                    TAR011_mview.Parent = _pageView;
                    _pageView.Controls.Add(TAR011_mview);
                    _pageView.Text = TAR011_mview.Text;
                    _pageView.Tag = ((System.Windows.Forms.ToolStripItem)(sender)).Tag;
                    tabViews.Pages.Add(_pageView);
                    TAR011_mview.Show();
                }
