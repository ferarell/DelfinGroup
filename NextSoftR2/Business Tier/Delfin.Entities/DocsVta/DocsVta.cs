...
{
	[Serializable()]
	public partial class DocsVta : MasterBusinessEntity, INotifyPropertyChanged
	{
		#region [ Variables ]
		...
		private Nullable<Int32> m_pdoc_codigo;
		private Nullable<Int32> m_entc_codigo;
		private String m_docv_hbl;
		private String m_docv_nrooperacion;
		private Nullable<Int32> m_docv_codigopadre;
		...
		/// <summary>
		/// Inicializar una nueva instancia de la clase DocsVta.
		/// </summary>
		public DocsVta()
		{  }
		#endregion
		...
		/// </summary>
		[DataMember]
		public Nullable<Int32> PDOC_Codigo
		{
		...
		/// <summary>
		/// Gets or sets el valor de: DOCV_HBL.
		/// </summary>
		[DataMember]
		public String DOCV_HBL
		{
			get { return m_docv_hbl; }
			set
			{
				if (m_docv_hbl != value)
				{
					m_docv_hbl = value;
					OnPropertyChanged("DOCV_HBL");
				}
			}
		}
		/// <summary>
		/// Gets or sets el valor de: DOCV_NroOperacion.
		/// </summary>
		[DataMember]
		public String DOCV_NroOperacion
		{
			get { return m_docv_nrooperacion; }
			set
			{
				if (m_docv_nrooperacion != value)
				{
					m_docv_nrooperacion = value;
					OnPropertyChanged("DOCV_NroOperacion");
				}
			}
		}
		/// <summary>
		/// Gets or sets el valor de: DOCV_CodigoPadre.
		/// </summary>
		[DataMember]
		public Nullable<Int32> DOCV_CodigoPadre
		{
			get { return m_docv_codigopadre; }
			set
			{
				if (m_docv_codigopadre != value)
				{
					m_docv_codigopadre = value;
					OnPropertyChanged("DOCV_CodigoPadre");
				}
			}
		}
        /// <summary>
		...
		#region [ CopyTo ]
		public void CopyTo(ref DocsVta Item)
		{
			try
			{
				if (Item == null) { Item = new DocsVta(); }
				...
				Item.DOCV_HBL = this.DOCV_HBL;
                Item.TIPE_Codigo = this.TIPE_Codigo;
				Item.DOCV_NroOperacion = this.DOCV_NroOperacion;
				Item.DOCV_CodigoPadre = this.DOCV_CodigoPadre;
			}
			catch (Exception ex)
			{ throw ex; }
		}
