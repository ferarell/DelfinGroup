	...
	public partial class DocsVta
	{
      ...
      public String TIPE_CodigoMSGERROR
      {
		...
		public Boolean Validar()
		{
            ...
            //   _isCorrect = false;
            //   DOCV_CodigoOK  = false;
            //   DOCV_CodigoMSGERROR  = String.Format("Debe ingresar el {0} de la {1}.", "DOCV_Codigo", "DocsVta");
            ...
            //   _isCorrect = false;
            //   DOCV_NumeroOK  = false;
            //   DOCV_NumeroMSGERROR  = String.Format("Debe ingresar el {0} de la {1}.", "DOCV_Numero", "DocsVta");
            //   m_mensajeError += "* Debe ingresar el campo DOCV_Numero" + Environment.NewLine;
            //}
				DOCV_TipoCambioOK  = true;
				DOCV_TipoCambioMSGERROR  = "";
				if( DOCV_TipoCambio == null)
				{
					_isCorrect = false;
					DOCV_TipoCambioOK  = false;
					DOCV_TipoCambioMSGERROR  = String.Format("Debe ingresar el {0} de la {1}.", "Tipo de Cambio", "Documento");
               m_mensajeError += "* Debe ingresar el campo Tipo de Cambio" + Environment.NewLine;
				...
				if( DOCV_PrecVtaTotal == null)
				{
					_isCorrect = false;
					DOCV_PrecVtaTotalOK  = false;
					DOCV_PrecVtaTotalMSGERROR  = String.Format("Debe ingresar el {0} de la {1}.", "Precio de Venta", "Documento");
               m_mensajeError += "* Debe ingresar el campo Precio de Venta" + Environment.NewLine;
				}
				DOCV_PrecVtaTotalDOK  = true;
				DOCV_PrecVtaTotalDMSGERROR  = "";
            //if( DOCV_PrecVtaTotalD == null)
            //{
            //   _isCorrect = false;
            //   DOCV_PrecVtaTotalDOK  = false;
            //   DOCV_PrecVtaTotalDMSGERROR = String.Format("Debe ingresar el {0} de la {1}.", "DOCV_PrecVtaTotalD", "Documento");
            //   m_mensajeError += "* Debe ingresar el campo DOCV_PrecVtaTotalD" + Environment.NewLine;
            //}
				DOCV_ValorTotalOK  = true;
				DOCV_ValorTotalMSGERROR  = "";
				if( DOCV_ValorTotal == null)
				{
					_isCorrect = false;
					DOCV_ValorTotalOK  = false;
               DOCV_ValorTotalMSGERROR = String.Format("Debe ingresar el {0} de la {1}.", "Valor de Venta", "Documento");
               m_mensajeError += "* Debe ingresar el campo Valor de Venta" + Environment.NewLine;
				}
				DOCV_ValorTotalDOK  = true;
				DOCV_ValorTotalDMSGERROR  = "";
            //if( DOCV_ValorTotalD == null)
            //{
            //   _isCorrect = false;
            //   DOCV_ValorTotalDOK  = false;
            //   DOCV_ValorTotalDMSGERROR = String.Format("Debe ingresar el {0} de la {1}.", "DOCV_ValorTotalD", "Documento");
            //   m_mensajeError += "* Debe ingresar el campo DOCV_ValorTotalD" + Environment.NewLine;
            //}
				DOCV_ValorVtaTotalOK  = true;
				DOCV_ValorVtaTotalMSGERROR  = "";
				if( DOCV_ValorVtaTotal == null)
				{
					_isCorrect = false;
					DOCV_ValorVtaTotalOK  = false;
               DOCV_ValorVtaTotalMSGERROR = String.Format("Debe ingresar el {0} de la {1}.", "Valor de Venta Total", "Documento");
               m_mensajeError += "* Debe ingresar el campo Valor de Venta Total" + Environment.NewLine;
				}
				DOCV_ValorVtaTotalDOK  = true;
				DOCV_ValorVtaTotalDMSGERROR  = "";
            //if( DOCV_ValorVtaTotalD == null)
            //{
            //   _isCorrect = false;
            //   DOCV_ValorVtaTotalDOK  = false;
            //   DOCV_ValorVtaTotalDMSGERROR = String.Format("Debe ingresar el {0} de la {1}.", "DOCV_ValorVtaTotalD", "Documento");
            ...
            //}
               ...
               DOCV_DescuentoMSGERROR = String.Format("Debe ingresar el {0} de la {1}.", "Descuento", "Documento");
            ...
            //   DOCV_DescuentoDMSGERROR = String.Format("Debe ingresar el {0} de la {1}.", "DOCV_DescuentoD", "Documento");
            ...
            //}
               ...
               DOCV_ObservacionesMSGERROR = String.Format("Debe ingresar el {0} de la {1}.", "Observaciones", "Documento");
					m_mensajeError += "* Debe ingresar el campo Observaciones" + Environment.NewLine;
				}
				DOCV_Impuesto1OK  = true;
				DOCV_Impuesto1MSGERROR  = "";
				if( DOCV_Impuesto1 == null)
				{
					_isCorrect = false;
					DOCV_Impuesto1OK  = false;
               DOCV_Impuesto1MSGERROR = String.Format("Debe ingresar el {0} de la {1}.", "Impuesto", "Documento");
					m_mensajeError += "* Debe ingresar el campo Impuesto" + Environment.NewLine;
				}
				DOCV_Impuesto1DOK  = true;
				DOCV_Impuesto1DMSGERROR  = "";
            //if( DOCV_Impuesto1D == null)
            //{
            //   _isCorrect = false;
            //   DOCV_Impuesto1DOK  = false;
            //   DOCV_Impuesto1DMSGERROR = String.Format("Debe ingresar el {0} de la {1}.", "DOCV_Impuesto1D", "Documento");
            ...
            //   DOCV_Impuesto2MSGERROR = String.Format("Debe ingresar el {0} de la {1}.", "DOCV_Impuesto2", "Documento");
            ...
            //   DOCV_Impuesto2DMSGERROR = String.Format("Debe ingresar el {0} de la {1}.", "DOCV_Impuesto2D", "Documento");
            ...
            //   DOCV_Impuesto3MSGERROR = String.Format("Debe ingresar el {0} de la {1}.", "DOCV_Impuesto3", "Documento");
            ...
            //   DOCV_Impuesto3DMSGERROR = String.Format("Debe ingresar el {0} de la {1}.", "DOCV_Impuesto3D", "Documento");
            ...
            //   DOCV_Impuesto4MSGERROR = String.Format("Debe ingresar el {0} de la {1}.", "DOCV_Impuesto4", "Documento");
            ...
            //   DOCV_Impuesto4DMSGERROR = String.Format("Debe ingresar el {0} de la {1}.", "DOCV_Impuesto4D", "Documento");
            ...
            //   DOCV_PorcImp1MSGERROR = String.Format("Debe ingresar el {0} de la {1}.", "DOCV_PorcImp1", "Documento");
            ...
            //   DOCV_PorcImp2MSGERROR = String.Format("Debe ingresar el {0} de la {1}.", "DOCV_PorcImp2", "Documento");
            ...
            //   DOCV_PorcImp3MSGERROR = String.Format("Debe ingresar el {0} de la {1}.", "DOCV_PorcImp3", "Documento");
            ...
            //   DOCV_PorcImp4MSGERROR = String.Format("Debe ingresar el {0} de la {1}.", "DOCV_PorcImp4", "Documento");
            ...
            //}
				...
				if( String.IsNullOrEmpty(DOCV_Serie) )
				{
					_isCorrect = false;
					DOCV_SerieOK  = false;
               DOCV_SerieMSGERROR = String.Format("Debe ingresar el {0} de la {1}.", "Serie", "Documento");
      ...
      public Boolean ValidarFL()
      {
         try
         {
            ...
            if (String.IsNullOrEmpty(TIPO_CodMND))
            {
               _isCorrect = false;
               TIPO_CodMNDOK = false;
               TIPO_CodMNDMSGERROR = String.Format("Debe ingresar el {0} de la {1}.", "Moneda", "DocsVta");
            ...
            if (String.IsNullOrEmpty(TIPO_CodTDO))
            {
               _isCorrect = false;
               TIPO_CodTDOOK = false;
               TIPO_CodTDOMSGERROR = String.Format("Debe ingresar el {0} de la {1}.", "Tipo de Documento", "DocsVta");
            ...
            if (TIPE_Codigo == 0)
            {
               _isCorrect = false;
               TIPE_CodigoOK = false;
               TIPE_CodigoMSGERROR = String.Format("Debe ingresar el {0} de la {1}.", "Tipo Entidad", "DocsVta");
               m_mensajeError += "* Debe ingresar el campo Tipo Entidad" + Environment.NewLine;
            }
            ...
            if (ENTC_Codigo == null)
            {
               _isCorrect = false;
               ENTC_CodigoOK = false;
               ENTC_CodigoMSGERROR = String.Format("Debe ingresar el {0} de la {1}.", "Entidad", "DocsVta");
