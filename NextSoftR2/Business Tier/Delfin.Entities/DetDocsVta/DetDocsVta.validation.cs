		...
		public Boolean Validar()
		{
			try
			{
				...
				if( DDOV_Item == null)
				{
					_isCorrect = false;
					DDOV_ItemOK  = false;
					DDOV_ItemMSGERROR  = String.Format("Debe ingresar el {0} de la {1}.", "DDOV_Item", "DetDocsVta");
					m_mensajeError += "* Debe ingresar el campo DDOV_Item" + Environment.NewLine;
				}
				DDOV_CantidadOK  = true;
				DDOV_CantidadMSGERROR  = "";
				if( DDOV_Cantidad == null)
				{
					_isCorrect = false;
					DDOV_CantidadOK  = false;
					DDOV_CantidadMSGERROR  = String.Format("Debe ingresar el {0} de la {1}.", "DDOV_Cantidad", "DetDocsVta");
					m_mensajeError += "* Debe ingresar el campo DDOV_Cantidad" + Environment.NewLine;
				}
				DDOV_PrecioUnitarioOK  = true;
				DDOV_PrecioUnitarioMSGERROR  = "";
				if( DDOV_PrecioUnitario == null)
				{
					_isCorrect = false;
					DDOV_PrecioUnitarioOK  = false;
					DDOV_PrecioUnitarioMSGERROR  = String.Format("Debe ingresar el {0} de la {1}.", "DDOV_PrecioUnitario", "DetDocsVta");
					m_mensajeError += "* Debe ingresar el campo DDOV_PrecioUnitario" + Environment.NewLine;
				}
				...
				if( DDOV_PrecioUnitarioD == null)
				{
					...
					DDOV_PrecioUnitarioDMSGERROR  = String.Format("Debe ingresar el {0} de la {1}.", "DDOV_PrecioUnitarioD", "DetDocsVta");
				...
				if( DDOV_ValorVenta == null)
				{
					_isCorrect = false;
					DDOV_ValorVentaOK  = false;
					DDOV_ValorVentaMSGERROR  = String.Format("Debe ingresar el {0} de la {1}.", "DDOV_ValorVenta", "DetDocsVta");
					m_mensajeError += "* Debe ingresar el campo DDOV_ValorVenta" + Environment.NewLine;
				}
				DDOV_ValorVentaDOK  = true;
				DDOV_ValorVentaDMSGERROR  = "";
				if( DDOV_ValorVentaD == null)
				{
					_isCorrect = false;
					DDOV_ValorVentaDOK  = false;
					DDOV_ValorVentaDMSGERROR  = String.Format("Debe ingresar el {0} de la {1}.", "DDOV_ValorVentaD", "DetDocsVta");
					m_mensajeError += "* Debe ingresar el campo DDOV_ValorVentaD" + Environment.NewLine;
				}
				DDOV_Impuesto1OK  = true;
				DDOV_Impuesto1MSGERROR  = "";
				if( DDOV_Impuesto1 == null)
				{
					_isCorrect = false;
					DDOV_Impuesto1OK  = false;
					DDOV_Impuesto1MSGERROR  = String.Format("Debe ingresar el {0} de la {1}.", "DDOV_Impuesto1", "DetDocsVta");
					m_mensajeError += "* Debe ingresar el campo DDOV_Impuesto1" + Environment.NewLine;
				}
				...
				if( DDOV_Impuesto1D == null)
				{
					...
					DDOV_Impuesto1DMSGERROR  = String.Format("Debe ingresar el {0} de la {1}.", "DDOV_Impuesto1D", "DetDocsVta");
				...
				if( DDOV_Impuesto2 == null)
				{
					...
					DDOV_Impuesto2MSGERROR  = String.Format("Debe ingresar el {0} de la {1}.", "DDOV_Impuesto2", "DetDocsVta");
				...
				if( DDOV_Impuesto2D == null)
				{
					...
					DDOV_Impuesto2DMSGERROR  = String.Format("Debe ingresar el {0} de la {1}.", "DDOV_Impuesto2D", "DetDocsVta");
				...
				if( DDOV_Impuesto3 == null)
				{
					...
					DDOV_Impuesto3MSGERROR  = String.Format("Debe ingresar el {0} de la {1}.", "DDOV_Impuesto3", "DetDocsVta");
				...
				if( DDOV_Impuesto3D == null)
				{
					...
					DDOV_Impuesto3DMSGERROR  = String.Format("Debe ingresar el {0} de la {1}.", "DDOV_Impuesto3D", "DetDocsVta");
				...
				if( DDOV_Impuesto4 == null)
				{
					...
					DDOV_Impuesto4MSGERROR  = String.Format("Debe ingresar el {0} de la {1}.", "DDOV_Impuesto4", "DetDocsVta");
				...
				if( DDOV_Impuesto4D == null)
				{
					...
					DDOV_Impuesto4DMSGERROR  = String.Format("Debe ingresar el {0} de la {1}.", "DDOV_Impuesto4D", "DetDocsVta");
				...
				if( DOCV_Codigo == null)
				{
					_isCorrect = false;
					DOCV_CodigoOK  = false;
					DOCV_CodigoMSGERROR  = String.Format("Debe ingresar el {0} de la {1}.", "DOCV_Codigo", "DetDocsVta");
				...
				if( SERV_Codigo == null)
				{
					_isCorrect = false;
					SERV_CodigoOK  = false;
					SERV_CodigoMSGERROR  = String.Format("Debe ingresar el {0} de la {1}.", "SERV_Codigo", "DetDocsVta");
				...
				if( String.IsNullOrEmpty(DDOV_Descripcion) )
				{
					...
					DDOV_DescripcionMSGERROR  = String.Format("Debe ingresar el {0} de la {1}.", "DDOV_Descripcion", "DetDocsVta");
