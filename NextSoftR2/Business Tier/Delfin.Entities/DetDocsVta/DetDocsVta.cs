...
{
	[Serializable()]
	public partial class DetDocsVta : MasterBusinessEntity, INotifyPropertyChanged
	{
		#region [ Variables ]
		private Int16 m_ddov_item;
		...
		/// <summary>
		/// Inicializar una nueva instancia de la clase DetDocsVta.
		/// </summary>
		public DetDocsVta()
		{  }
		#endregion
		...
		#region [ CopyTo ]
		public void CopyTo(ref DetDocsVta Item)
		{
			try
			{
				if (Item == null) { Item = new DetDocsVta(); }
