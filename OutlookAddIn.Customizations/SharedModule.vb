...
Module SharedModule
    ...
    Friend Function SendNewMessage(TypMsg As String, oMailItem As Outlook.MailItem, Identifier As String, Message As String, Attachments As ArrayList) As Boolean
        ...
        ElseIf TypMsg = "PRC_OK" Then
            ...
            If oMailItem.HTMLBody.Trim = "" Then
                NewMessage.HTMLBody = GetProcessResponseMessage(1, oMailItem.SenderName, Message, 0)
            Else
        ...
        ElseIf TypMsg = "PRC_ERROR" Then
            ...
            NewMessage.BCC = My.Settings.MailSupport
            NewMessage.HTMLBody = GetProcessResponseMessage(2, oMailItem.SenderName, Message, 0)
        ElseIf TypMsg = "PRC_INFO" Then
            NewMessage.Subject = "Información: " & Identifier
            'NewMessage.CC = "itsupport@delfingroupco.com.pe"
            NewMessage.BCC = My.Settings.MailSupport & "; importcustomerpe@delfingroupco.com.pe"
            NewMessage.HTMLBody = GetProcessResponseMessage(3, oMailItem.SenderName, Message, 0)
        End If
        NewMessage.Send()
    ...
    Friend Function GetProcessResponseMessage(iProcess As Integer, SenderName As String, Message As String, iProcessType As Integer) As String
        ...
        oText.AppendText("<html><body lang=ES style='tab-interval:35.4pt;font-size:10.0pt;font-family:""Calibri"",sans-serif;color: #0c3954;'>")
        ...
        ElseIf iProcess = 2 Then
            ...
            If drConfig("IdInputType") = 4 Then
        ...
        ElseIf iProcess = 3 Then
            ...
            End If
        End If
        oText.AppendText(UnicodeBytesToString(drConfig("Signature")))
        Return oText.Text
    End Function
