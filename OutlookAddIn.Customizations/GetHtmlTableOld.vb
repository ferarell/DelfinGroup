...
Public Class GetHtmlTableOld
    ...
    Friend Function GenerateTable(dtSource As DataTable) As String
        ...
        For col = 0 To dtSource.Columns.Count - 1
            ...
            Msg.AppendText("mso-border-alt:solid windowtext .5pt;background:#2E9AFE;padding:0cm 5.4pt 0cm 5.4pt'>")
            Msg.AppendText("<p class=MsoNormal align=center style='margin-middle:0cm;margin-middle:.0001pt;")
