...
Imports OutlookAddIn.Customizations.PorticoService
...
Public Class SettingsForm
    ...
    Dim oProxyService As New PorticoService.PorticoClient
    ...
    Private Sub GetConfiguration(GridName As String)
        ...
        If dtInputList.Rows.Count = 0 Or GridView1.GetFocusedRowCellValue("IdInputConfiguration") Is Nothing Then
            Return
        End If
        dtConfiguration = ExecuteSQL("EXEC ptc.upGetConfigurationById " & GridView1.GetFocusedRowCellValue("IdInputConfiguration") & ", " & GridView2.GetFocusedRowCellValue("IdMessageStructure"))
