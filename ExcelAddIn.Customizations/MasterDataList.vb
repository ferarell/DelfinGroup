...
Public Class MasterDataList
    ...
    Friend Function LoadMasterData(TableName As String, Params As ArrayList) As DataTable
        ...
        ElseIf TableName = "NoticeLayout" Then
            QueryText = "EXEC NextSoft.dgp.paListaFormatoAviso"
        ElseIf TableName = "Via" Then
            QueryText = "EXEC NextSoft.dgp.paListaVia"
        ElseIf TableName = "Event" Then
        ...
        ElseIf TableName = "Shipline" Then
            QueryText = "EXEC NextSoft.dgp.paListaTransportista"
        End If
        Try
