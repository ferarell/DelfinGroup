...
Public Class DelfinServiceTest
    Implements IDelfinServiceTest

    Public Function ExecuteSQL(ByVal QueryString As String) As DataSet Implements IDelfinServiceTest.ExecuteSQL
        Try
    ...
    Public Function NewExecuteSQL(ByVal QueryString As String) As DataSet Implements IDelfinServiceTest.NewExecuteSQL
    ...
    Public Function ExecuteSQLNonQuery(ByVal QueryString As String) As Boolean Implements IDelfinServiceTest.ExecuteSQLNonQuery
    ...
    Public Function NewExecuteSQLNonQuery(ByVal QueryString As String) As ArrayList Implements IDelfinServiceTest.NewExecuteSQLNonQuery
    ...
    Public Function GetActiveDirectoryObjects(ByVal DirectoryEntry As String, ByVal DirectoryUserName As String) As DataSet Implements IDelfinServiceTest.GetActiveDirectoryObjects
        Try
    ...
    Public Function UserValidation(ByVal DirectoryEntry As String, ByVal DirectoryUserName As String, ByVal DirectoryPassword As String, ByVal ErrorMessage As String) As String Implements IDelfinServiceTest.UserValidation
    ...
    Public Function GenerateNextSisVoucher(ByVal Company As String, ByVal dsVoucher As DataSet) As ArrayList Implements IDelfinServiceTest.GenerateNextSisVoucher
        Dim aResult As New ArrayList
        ...
        Using connection As New SqlConnection(ConfigurationManager.AppSettings("dbSolutionTest"))
            ...
            Try
                ...
                For r = 0 To dtDetail.Rows.Count - 1
                    ...
                    Command.Parameters.Add("@DETA_DEBE", SqlDbType.Decimal).Value = dRow("DETA_DEBE")
                    Command.Parameters.Add("@DETA_HABER", SqlDbType.Decimal).Value = dRow("DETA_HABER")
                    Command.Parameters.Add("@DETA_DEBEDOL", SqlDbType.Decimal).Value = dRow("DETA_DEBEDOL")
                    ...
                    Command.Parameters.Add("@DETA_HABERDOL", SqlDbType.Decimal).Value = dRow("DETA_HABERDOL")
    ...
    Public Function GenerateNextSisVoucherBCopy(ByVal Company As String, ByVal dsVoucher As DataSet) As ArrayList Implements IDelfinServiceTest.GenerateNextSisVoucherBCopy
        Dim aResult As New ArrayList
        Dim dtHeader As DataTable = dsVoucher.Tables("VoucherH")
        Dim dtDetail As DataTable = dsVoucher.Tables("VoucherD")
        Dim sNroVoucher As String = ""
    ...
    Public Function GenerateNextSoftVoucher(dtMovimiento As DataTable, dtCtaCte As DataTable) As ArrayList Implements IDelfinServiceTest.GenerateNextSoftVoucher
        Dim aResult As New ArrayList
    ...
    Public Function InsertarContribuyente(ByVal dtSource As DataTable) As ArrayList Implements IDelfinServiceTest.InsertarContribuyente
        Dim aResult As New ArrayList
        aResult.AddRange({1, ""})
    ...
    Public Function ActualizarContribuyente(ByVal dtSource As DataTable) As ArrayList Implements IDelfinServiceTest.ActualizarContribuyente
        Dim aResult As New ArrayList
        aResult.AddRange({1, ""})
        Dim drSource As DataRow = dtSource.Rows(0)
        Using connection As New SqlConnection(ConfigurationManager.AppSettings("dbSolutionTest"))
