...
Public Class ImpresionBoleta
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Integrador.ImpresionBoleta.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_RasonSocial() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedImpresionBoleta
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ImpresionBoleta = New ImpresionBoleta()
        rpt.Site = Me.Site
        Return rpt
    End Function
