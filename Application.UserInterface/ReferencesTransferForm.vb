...
Public Class ReferencesTransferForm
    ...
    Private Sub GridView1_FocusedRowChanged(sender As Object, e As DevExpress.XtraGrid.Views.Base.FocusedRowChangedEventArgs) Handles GridView1.FocusedRowChanged
        ...
        End If
        Dim dtQuery As New DataTable
        dtQuery = oAppService.ExecuteSQL("EXEC NextSoft.dgp.paObtieneListaOvPorEta '" & Format(deDateFrom.EditValue, "yyyyMMdd") & "','" & Format(deDateTo.EditValue, "yyyyMMdd") & "'").Tables(0)
        ...
        For r = 0 To GridView2.DataRowCount - 1
            ...
            Try
                ...
                If dsReferences.Tables(0).Rows.Count = 0 Then
                    ...
                    Dim _Text As String = "El HBL: " & HBL & " no tiene referencias asociadas"
                    oLogFileGenerate.TextFileUpdate("SAP_REFERENCES", _Text)
                    Continue For
                End If
                Dim aRespuesta As New ArrayList
                ...
                If aRespuesta(0).RespuestaSAP = 0 Then
                    ...
                    Dim _Text As String = "Ocurrió un error al actualizar las referencias del HBL: " & HBL & " en SAP" & vbCrLf & DirectCast(aRespuesta(0), ApplicationForm.IntegrationService.Respuesta).Response(0).[error].Message.Value
                    oLogFileGenerate.TextFileUpdate("SAP_REFERENCES", _Text)
                End If
            Catch ex As Exception
                'SplashScreenManager.CloseForm(False)
                'XtraMessageBox.Show(ex.Message, "Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
                Dim _Text As String = "HBL: " & HBL & " / ERROR: " & ex.Message
                oLogFileGenerate.TextFileUpdate("SAP_REFERENCES", _Text)
            End Try
        Next
        SplashScreenManager.CloseForm(False)
        XtraMessageBox.Show("El proceso terminó satisfactoriamente", "Información", MessageBoxButtons.OK, MessageBoxIcon.Information)
    End Sub
