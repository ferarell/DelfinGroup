...
Public Class CargoAddressingForm
    ...
    Private Sub CargoAddressingForm_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        SplitContainerControl4.SplitterPosition = SplitContainerControl4.Height * 0.6
    ...
    Private Sub LoadInputValidations()
        ...
        vpInputs.SetValidationRule(Me.teHBL, Nothing)
        If teHBL.Text.Trim.Length = 0 Then
    ...
    Private Sub ButtonEnabled()
        ...
        bsiExtranetRequest.Enabled = False
        bbiApproveRequest.Enabled = False
        bbiRejectRequest.Enabled = False
        ...
        'Next
        SplitContainerControl2.PanelVisibility = DevExpress.XtraEditors.SplitPanelVisibility.Panel1
        If GridView1.GetFocusedRowCellValue("SolicitudExtranet") > 0 Then
            bsiExtranetRequest.Enabled = True
            SplitContainerControl2.PanelVisibility = DevExpress.XtraEditors.SplitPanelVisibility.Both
        End If
        If GridView2.GetFocusedRowCellValue("ENDI_Estado") = "P" Then
            bbiApproveRequest.Enabled = True
            bbiRejectRequest.Enabled = True
        End If
    End Sub
    ...
    Private Sub GridView1_FocusedRowChanged(sender As Object, e As DevExpress.XtraGrid.Views.Base.FocusedRowChangedEventArgs) Handles GridView1.FocusedRowChanged
        ...
        If e.FocusedRowHandle < 0 Then
            Return
        End If
        Dim dtContainers, dtExtranetRequest As New DataTable
        ...
        If GridView1.GetFocusedRowCellValue("SolicitudExtranet") > 0 Then
            dtExtranetRequest = oAppService.ExecuteSQL("EXEC NextSoft.dgp.paObtieneDireccionamientoSolicitado '" & GridView1.GetFocusedRowCellValue("HBL").ToString & "'").Tables(0)
            gcExtranetRequest.DataSource = dtExtranetRequest
    ...
    Private Sub GridView1_RowStyle(ByVal sender As Object, ByVal e As DevExpress.XtraGrid.Views.Grid.RowStyleEventArgs) Handles GridView1.RowStyle
        ...
        If (e.RowHandle >= 0) Then
            Dim _SolicitudExtranet As Integer = 0
            If Not View.Columns("SolicitudExtranet") Is Nothing Then
                _SolicitudExtranet = View.GetRowCellDisplayText(e.RowHandle, View.Columns("SolicitudExtranet"))
            End If

            If _SolicitudExtranet > 0 Then
    ...
    Private Sub bbiApproveRequest_ItemClick(sender As Object, e As DevExpress.XtraBars.ItemClickEventArgs) Handles bbiApproveRequest.ItemClick
        If DevExpress.XtraEditors.XtraMessageBox.Show("Está seguro de aprobar esta solicitud? ", "Confirmación", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = Forms.DialogResult.No Then
            Return
        End If
    End Sub

    Private Sub bbiRejectRequest_ItemClick(sender As Object, e As DevExpress.XtraBars.ItemClickEventArgs) Handles bbiRejectRequest.ItemClick
        If DevExpress.XtraEditors.XtraMessageBox.Show("Está seguro de rechazar esta solicitud? ", "Confirmación", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = Forms.DialogResult.No Then
            Return
        End If
    End Sub
End Class